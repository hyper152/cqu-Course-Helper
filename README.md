# cqu-Course-Helper
一份功能简单的油猴（Tampermonkey）脚本，可用于cqu课程平台
## ✨ 功能特点 (Features)
...
**安装用户脚本管理器**
    ...
    复制"cqu-Course-Helper.js"的全部代码，打开Tampermonkey，添加新脚本，粘贴代码即可。

## 📖 使用说明 (Usage)

1.  安装脚本后，无需任何配置。
2.  用浏览器正常访问cqu课程平台的视频课程页面，点开某个课程的视频。
...
模仿的NJU大手子https://github.com/xiaoch669/NJU_Auto-Course-Helper?tab=readme-ov-file